            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden md:flex w-full md:max-w-4xl">
                ...
                <div className="w-full md:w-1/2 px-6 py-10">
                    ...
                    <form>
                        ...
                        <button className="w-full bg-[#FFF346] text-black py-2 rounded-lg hover:bg-yellow-300 transition duration-300">Login</button>

                        
                        <button className="w-full bg-[#5CD9FF] text-black py-2 rounded-lg hover:bg-yellow-300 transition duration-300">Register</button>
